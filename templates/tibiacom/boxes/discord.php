...
<div class="Themebox" style="height: 170px;">
    ...
    <div class="btn_themebox_discord">
        <a href="<?= $config['discord_link']; ?>">
            <div class="BigButton" style="background-image:url(<?= $template_path ?>/images/global/buttons/button.png); width: 142px; height: 34px;">
                <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                    <div class="BigButtonOver" style="background-image: url(<?= $template_path ?>/images/global/buttons/button_hover.png); visibility: hidden;"></div>
                    <input class="BigButtonText" style="width: 142px; height: 34px;" type="button" value="Join Discord"></div>
            </div>
        </a>
    </div>
