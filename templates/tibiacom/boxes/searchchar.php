<style>
    .header_themebox {
        height: 31px;
        background: url(<?= $template_path ?>/images/themeboxes/exemple/header-bg.png);
        z-index: 2;
        width: 100%;
        position: absolute;
    }
...
<div class="Themebox" style="height: 170px;">
    <form method="post" action="?characters">
        ...
        <div class="content_themebox" style="background-image:url(<?= $template_path ?>/images/themeboxes/exemple/border.png); height: 130px;">
        ...
        <div class="btn_themebox_searchchar">
            <div class="BigButton" style="background-image:url(<?= $template_path ?>/images/global/buttons/button_green.png); width: 142px; height: 34px;">
                <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                    <div class="BigButtonOver" style="background-image: url(<?= $template_path ?>/images/global/buttons/button_green_hover.png); visibility: hidden;"></div>
                    <input class="BigButtonText" style="width: 142px; height: 34px;" type="submit" value="Search"></div>
            </div>
        </div>
    </form>
